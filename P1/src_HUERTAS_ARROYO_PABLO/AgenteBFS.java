...
public class AgenteBFS extends AbstractPlayer {
    ...
    public AgenteBFS(StateObservation stateObs, ElapsedCpuTimer elapsedTimer){
        ...
        //Inicializo el objeto de la clase de Busqueda en Anchura
        BFS = new BusquedaAnchura(stateObs);
    }
    ...
    public Types.ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
    	...
    	{   
    	    ...
    	    camino = BFS.CalculaCamino(inicial, objetivo);
    		...
    		System.out.println("Numero de nodos expandidos->"+BFS.GetNodosExpandidos());
            System.out.println("Maximo de nodos en memorias->"+BFS.GetMaxNodosMemoria());
